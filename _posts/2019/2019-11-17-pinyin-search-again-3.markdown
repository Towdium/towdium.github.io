...
对字典树而言，合并加速的效果对密集的树结构比较显著，而跳转加速则对松散的结构更有效。在中文场景下，由于字符量大，树结构本来就要更加松散，因此失去了跳转加速对性能的影响十分明显。不过话说回来，是否存在遍历法以外的胶水层实现让我们重新获得跳转加速呢？你也猜到了，既然我已经这么问了，那自然是有的。
